...
- 8.6: [`MonadFailDesugaring`](https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/glasgow_exts.html#extension-MonadFailDesugaring) 言語拡張がデフォルトに
    - do 記法の `fail` への脱糖が `MonadFail` のものになる

## 8.6

[リリースノートはこれ](https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/8.6.1-notes.html)．

### QuantifiedConstraints

- [QuantifiedConstraints](https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/glasgow_exts.html#extension-QuantifiedConstraints) 言語拡張を追加
- インスタンスの定義に量化が使える
...
- [`DerivingVia`](https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/glasgow_exts.html#extension-DerivingVia) 言語拡張について
...
- [コンパイルフラグ](https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/glasgow_exts.html#typed-hole-valid-hole-fits)で type Holes での推論アルゴリズム(?)のコントロールができるようになった(って感じかな)
